    ...
    <div class="h-full flex flex-col items-center py-4">
        ...
        <nav class="flex-1 w-full px-2 space-y-2 mt-6">
            ...
            <a href="https://enes-cde.vercel.app/users/">
                <button class="w-full p-3 flex justify-center rounded-lg text-gray-500 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-800">
                    <svg class="h-6 w-6  xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 48 48" stroke="currentColor" ><g id="SVGRepo_bgCarrier" stroke-width="currentColor"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> 
                      <path d="M0 0h48v48H0z" fill="none"></path> <g id="Shopicon"> 
